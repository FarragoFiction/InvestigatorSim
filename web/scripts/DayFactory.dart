...
abstract class DayFactory {
    ...
    static Map<String,DataPoint> day2DataPoints() {
        ...
        DataPoint cure = new DataPoint(DataPoint.CUREREACTION, "Standard antivirals have no measurable effect on the patients.","Standard antivirals have no measurable effect on the patients.","Standard antivirals have no measurable effect on the patients.", false);
        dataPoints[cure.name]=(cure);
        return dataPoints;
    }
    ...
    static Map<String,DataPoint> day3DataPoints() {
        ...
        DataPoint cure = new DataPoint(DataPoint.CUREREACTION, "Standard antifungals have no measurable effect on the patients.","Standard antifungals have no measurable effect on the patients.","Standard antifungals have no measurable effect on the patients.", false);
        dataPoints[cure.name]=(cure);
    ...
    static Map<String,DataPoint> day4DataPoints() {
        ...
        DataPoint cure = new DataPoint(DataPoint.CUREREACTION, "Autoimmune suppresants have no measurable effect on the patients.","Autoimmune suppresants have no measurable effect on the patients.","Autoimmune suppresants have no measurable effect on the patients", false);
        dataPoints[cure.name]=(cure);
        return dataPoints;
    }
    ...
    static Map<String,DataPoint> day5DataPoints() {
        ...
        DataPoint cure = new DataPoint(DataPoint.CUREREACTION, "Extremely unscientific, last ditch magical spells have no measurable effect on the patients.","Extremely unscientific, last ditch magical spells have no measurable effect on the patients.","Extremely unscientific, last ditch magical spells have no measurable effect on the patients.", false);
        dataPoints[cure.name]=(cure);
        return dataPoints;
    }
    ...
    static Map<String,DataPoint> day6DataPoints() {
        ...
        DataPoint cure = new DataPoint(DataPoint.CUREREACTION, "It...it's a miracle. After exposure to a tree displaying a mutated strain of the infection, the patients have rapidly improved! They might not die! We might have a cure!","It...it's a miracle. After exposure to a tree displaying a mutated strain of the infection, the patients have rapidly improved! They might not die! We might have a cure! Finally!","It...it's a miracle. After exposure to a tree displaying a mutated strain of the infection, the patients have rapidly improved! They might not die! We might have a cure! Finally!", true);
        dataPoints[cure.name]=(cure);
        return dataPoints;
    }
